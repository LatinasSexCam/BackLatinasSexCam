...
public class TokenUtils {
    ...
    public String getTokenUser(User user){
        return createToken(user.getId_user(), user.getUser_name(), user.getEmail(), user.getRole());
    }

    public static String createToken(Long id, String nombre, String email, Role rol){
